...
- Native reopen tests reproduce Herdr rejecting explicitly targeted popup/overlay panes and verify restoration uses a split in the event workspace without changing picker preferences.
