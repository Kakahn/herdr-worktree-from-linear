...
Automated checks: **125 Node tests and 16 Python tests passed**.
...
- CLI adapter tests cover argument forwarding for all workflow command families, including commands that reject a global JSON flag.
