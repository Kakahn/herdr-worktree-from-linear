...
Automated checks: **139 Node tests and 16 Python tests passed**.
...
- Native reopen integration tests cover rebuilding all four roles in the initial tab, preserving an already-open workspace, and preserving extra panes opened during preparation.
